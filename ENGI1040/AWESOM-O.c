...
void main(void)
{
    ...
    while(1 )
    {
       ...
       leftSensor = readLeftSensor();
		...
		while(BusyXLCD());					// Wait until LCD display is finished displaying previous value																										
		WriteCmdXLCD(0x01);					// Clear the display
...
while(BusyXLCD());
    ...
    leftSensor = 0;
    frontSensor = 0;							// Variable to store front sensor value
    rightSensor = 0;
...
void goForward(void){
	...
	Delay1KTCYx(45);								// Changing the argument in the delay function will change the speed at which the motor rotates. Delay equals 1000 x 50 x 1/12 = 4.167 ms
...
void goForwardFastF(void){
				       ...
				       while(frontSensor < 450){
	                                            ...
	                                            rotateCW(1);    								// Rotate motor one step
                                               	...
                                               	Delay1KTCYx(25);								// Changing the argument in the delay function will change the speed at which the motor rotates. Delay equals 1000 x 50 x 1/12 = 4.167 ms
	                                            LATD = 0x00;									// Set all port D to 0	
												frontSensor = readFrontSensor();
